 ...
 *   um-multitool mobdump [options] <path/to/mobfile.mob>
 *   um-multitool mobdump [options] -d <path/to/directory>
 * 
 * Version:
 *   0.1
 * ============================================================================
...
static void PrintHelp() {
    std::cout << "um-mobdump - High-Performance Evil Islands .mob File Dumper\n\n"
              ...
              << "Examples:\n"
              << "  um-multitool mobdump maps/zone1.mob\n"
              << "  um-multitool mobdump -o ./dumped maps/zone1.mob\n"
              << "  um-multitool mobdump -d ./maps -o ./output -m\n"
              << "  um-multitool mobdump -d ./maps --dry-run\n";
}
