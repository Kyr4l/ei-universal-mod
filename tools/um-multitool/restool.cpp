 ...
 *   um-multitool restool [options] <path/to/archive.res|path/to/folder>
 *   um-multitool restool [options] -d <path/to/directory>
 *
 * Version:
 *   0.1
 * ============================================================================
...
static void PrintHelp() {
    std::cout << "um-restool - High-Performance Evil Islands RES/MQ Archive Tool\n\n"
              << "Usage:\n"
              << "  um-multitool restool [options] <path/to/archive.res|archive.mq|path/to/folder>\n"
              << "  um-multitool restool [options] -d <path/to/directory>\n\n"
              << "Options:\n"
              ...
              << "  um-multitool restool z3q1.mq                      # Unpacks to ./z3q1_mq/\n"
              << "  um-multitool restool ./figures_res                # Packs to ./figures.res\n"
              << "  um-multitool restool ./z3q1_mq                    # Packs to ./z3q1.mq\n"
              << "  um-multitool restool -d ./res_unpacked -o ./res -m # Batch packs all folders in parallel\n"
              << "  um-multitool restool -d ./mq-eng -m               # Batch packs all *_mq folders to *.mq\n"
              << "  um-multitool restool -d ./mq-eng -m -e quest.ini   # Same, but omit quest.ini from every archive\n";
}
