 ...
 *   um-multitool ddsmmp [options] <path/to/texture.dds|texture.mmp>
 *   um-multitool ddsmmp [options] -d <path/to/directory>
 *
 * Version:
 *   0.1
 * ============================================================================
...
static void PrintHelp() {
    std::cout << "um-ddsmmp - High-Performance Evil Islands DDS <-> MMP Texture Converter\n\n"
              ...
              << "Examples:\n"
              << "  um-multitool ddsmmp texture.dds               # Converts texture.dds -> texture.mmp\n"
              << "  um-multitool ddsmmp texture.mmp               # Converts texture.mmp -> texture.dds\n"
              << "  um-multitool ddsmmp -d ./textures_dds -o ./mmp -m  # Batch converts DDS to MMP in parallel\n"
              << "  um-multitool ddsmmp -d ./mmp --mmp2dds -m     # Batch converts MMP back to DDS in parallel\n";
}
