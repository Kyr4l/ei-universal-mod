 ...
 *   um-multitool inireg [options] <path/to/file.ini|file.reg>
 *   um-multitool inireg [options] -d <path/to/directory>
 *
 * Version:
 *   0.1
 * ============================================================================
...
static void PrintHelp() {
    std::cout << "um-inireg - High-Performance Evil Islands INI <-> REG Converter\n\n"
              ...
              << "Examples:\n"
              << "  um-multitool inireg config.ini                 # Creates config.reg\n"
              << "  um-multitool inireg config.reg                 # Creates config.ini\n"
              << "  um-multitool inireg -d ./ini -o ./reg -m       # Batch converts all INIs to REGs in parallel\n"
              << "  um-multitool inireg -d ./reg --reg2ini         # Batch converts all REGs back to INIs\n";
}
